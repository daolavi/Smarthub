...
namespace SmartHub.Repositories.Entities
{
    ...
    public partial class TicketEmailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TicketEmail>
    {
        public TicketEmailConfiguration()
            : this("dbo")
        {
        }

        public TicketEmailConfiguration(string schema)
        {
            ToTable(schema + ".TicketEmail");
            HasKey(x => x.Id);
            ...
            // Foreign keys
            HasRequired(a => a.Connection).WithMany(b => b.TicketEmails).HasForeignKey(c => c.ConnectionId).WillCascadeOnDelete(false); // FK_TicketEmail_Connection_ConnectionId
            InitializePartial();
        }
