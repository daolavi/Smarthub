...
namespace SmartHub.Repositories.Entities
{
    ...
    public partial class TicketEbayConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TicketEbay>
    {
        public TicketEbayConfiguration()
            : this("dbo")
        {
        }

        public TicketEbayConfiguration(string schema)
        {
            ToTable(schema + ".TicketEbay");
            HasKey(x => x.Id);
            ...
            // Foreign keys
            HasRequired(a => a.Connection).WithMany(b => b.TicketEbays).HasForeignKey(c => c.ConnectionId).WillCascadeOnDelete(false); // FK_TicketEbay_Connection_ConnectionId
            InitializePartial();
        }
